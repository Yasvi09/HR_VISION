...
import { sidebarRoutesHR } from "routes.js";
...
export default function Hr(props) {
  ...
  useEffect(() => {
    getActiveRoute(sidebarRoutesHR);
        ...
        >
          ...
          <div className="h-full">
            <Navbar
              ...
              secondary={getActiveNavbar(sidebarRoutesHR)}
              {...rest}
            />
            <div className="mb-auto h-full min-h-[89vh] p-2 pt-5 md:pr-2">
              <Routes>
                {getRoutes(sidebarRoutesHR)}
